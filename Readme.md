...
* Студент: [ИЛЬЯ](https://up.htmlacademy.ru/htmlcss/33/user/2022771).
* Наставник: `Арсений Берёзин`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2022771-sedona-33) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
